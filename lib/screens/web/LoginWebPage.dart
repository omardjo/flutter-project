...
import 'package:teamsyncai/screens/web/Registerweb.dart';
...
class _SignInPageState extends State<LoginWebPage> with SingleTickerProviderStateMixin {
    ...
    return ElevatedButton(
      onPressed: () async {
        if (buttonText == "Register") {
          Navigator.push(
            context,
            MaterialPageRoute(builder: (context) => const RegisterWeb()),
          );
        } else {
          final String email = _emailController.text;
          final String password = _passwordController.text;
