...
import 'package:teamsyncai/model/message_model.dart' as MyMessage;
...
class _RegisterState extends State<register>{
 ...
 Future<void> _sendEmailMessage(MyMessage.Message message) async {
  ...
  final messageToSend = Message()
    ...
    ..recipients.add(message.receiverEmail)
    ..subject = 'Welcome to TeamSynAi!-OTP for Registration'
    ..text = "Dear User Your OTP for registration is: 543210 This OTP is valid for a single use and should not be shared with anyone. Regards, TeamSynAi";
 ...
 onPressed: () async {
  ...
  try {
    ...
    final message = MyMessage.Message(
      senderEmail: 'mrdjebbi@gmail.com', // Update with sender's email
      receiverEmail: emailController.text, text: '', id: '', // Use the entered email as receiver's email
    );
